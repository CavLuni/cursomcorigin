...
import com.cavluni.cursomc.domain.ItemPedido;
import com.cavluni.cursomc.domain.Pagamento;
import com.cavluni.cursomc.domain.PagamentoComBoleto;
import com.cavluni.cursomc.domain.PagamentoComCartao;
import com.cavluni.cursomc.domain.Pedido;
import com.cavluni.cursomc.domain.Produto;
import com.cavluni.cursomc.domain.enuns.EstadoPagamento;
...
import com.cavluni.cursomc.repositories.CidadeRepository;
import com.cavluni.cursomc.repositories.ClienteRepository;
import com.cavluni.cursomc.repositories.EnderecoRepository;
import com.cavluni.cursomc.repositories.EstadoRepository;
import com.cavluni.cursomc.repositories.ItemPedidoRepository;
import com.cavluni.cursomc.repositories.PagamentoRepository;
import com.cavluni.cursomc.repositories.PedidoRepository;
import com.cavluni.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "denis.luniere@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "cavluniere@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("99973435", "95298765"));
		cli2.addPerfil(Perfil.ADMIN);
				
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2105", null, "Centro", "28177012", cli1, c2);
